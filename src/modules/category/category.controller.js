...
const getById = async (req, res, next) => {
  try {
    const category = await service.getById(req.params.id, req.user);
...
const create = async (req, res, next) => {
  try {
    const category = await service.create(req.user, req.body);
...
const update = async (req, res, next) => {
  try {
    const category = await service.update(req.params.id, req.user, req.body);
